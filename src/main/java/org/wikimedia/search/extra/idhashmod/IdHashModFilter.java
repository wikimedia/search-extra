...
public class IdHashModFilter extends Filter {
    ...
    public DocIdSet getDocIdSet(AtomicReaderContext context, Bits acceptDocs) throws IOException {
        ScriptDocValues.Strings uids = (ScriptDocValues.Strings) uidFieldData.load(context).getScriptValues();
    ...
    private class IdHashModDocIdSet extends MatchDocIdSet {
        private final ScriptDocValues.Strings uids;

        protected IdHashModDocIdSet(ScriptDocValues.Strings uids, int maxDoc, Bits acceptDocs) {
        ...
        protected boolean matchDoc(int doc) {
            ...
            int hash = uids.getValue().hashCode();
