...
public class SlovakStemmerFilterOpenSearchTest extends OpenSearchTestCase {
    private IndexAnalyzers indexAnalyzers;

    @Test
    public void testPrebuilt() throws IOException {
        assertAnalyzerAvailable("slovak_prebuilt", "prebuilt.json");
    }

    @Test
    public void testRedefined() throws IOException {
        assertAnalyzerAvailable("slovak_redefined", "redefined.json");
    }
    ...
    private void assertAnalyzerAvailable(String analyzerName, String analysisResource) throws IOException {
        ...
        Settings settings = Settings.builder()
                ...
                .build();
        indexAnalyzers = createTestAnalysis(indexProps, settings, new ExtraAnalysisSlovakPlugin()).indexAnalyzers;
        match(analyzerName, "Vitajte vo Wikipédii", "Vitajt vo Wikipédi");
    }
