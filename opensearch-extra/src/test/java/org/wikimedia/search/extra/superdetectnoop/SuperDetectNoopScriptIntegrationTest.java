...
public class SuperDetectNoopScriptIntegrationTest extends AbstractPluginIntegrationTest {
    ...
    public void setNewField() throws IOException {
        indexSeedData();
        XContentBuilder b =
                x("another_set", ImmutableMap.of("add", ImmutableList.of("cat", "tree")), "set");
        Map<String, Object> r = update(b, true);
    ...
    public void setNewFieldDeep() throws IOException {
        ...
        assertThat(
                ...
                hasEntry(
                        equalTo("o"),
                        (Matcher<Object>) (Matcher) hasEntry("new_set", ImmutableList.of("cow"))));
    }
    ...
    public void setAddFieldDeep() throws IOException {
        ...
        assertThat(
                ...
                hasEntry(
                        equalTo("o"),
                        (Matcher<Object>) (Matcher) hasEntry("set", ImmutableList.of("cow", "bat"))));
    }
    ...
    public void garbageDetector() throws IOException {
        ...
        assertRequestBuilderThrows(
                toUpdateRequest(b), IllegalArgumentException.class, RestStatus.BAD_REQUEST);
    }
    ...
    public void testReplaceMap() throws IOException {
        indexSeedData();
        Function<XContentBuilder, XContentBuilder> addSource =
                (builder) -> {
                    try {
                        return builder
                                .startObject("source")
