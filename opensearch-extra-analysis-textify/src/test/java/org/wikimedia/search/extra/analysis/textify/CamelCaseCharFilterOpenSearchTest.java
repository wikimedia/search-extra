...
public class CamelCaseCharFilterOpenSearchTest extends OpenSearchTestCase {
    private IndexAnalyzers indexAnalyzers;

    @Test
    public void testPrebuilt() throws IOException {
        assertAnalyzerAvailable("camelcase_prebuilt", "camel_prebuilt.json");
    }
    ...
    private void assertAnalyzerAvailable(String analyzerName, String analysisResource) throws IOException {
        ...
        match(analyzerName, "camelCaseTest", "camel Case Test");
    }
